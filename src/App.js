...
class App extends React.Component {
    ...
    newGame = (isDuel, player1, player2) => {
    ...
    makeMove = (player, x1, y1) =>  {
        ...
        Object.keys(this.state.coOrdinates).forEach(arr => {
            ...
            if(this.state.coOrdinates[arr][0] === x1 && this.state.coOrdinates[arr][1] === y1)
                this.Ai.board[arr] = currentPlayerSign;
        })
    ...
    onClickEndGame = () => {
        document.getElementById('board').style.opacity = '.5';
        ...
        menu.animate([{opacity: 0}, {opacity: 1}], {duration: 300});
    }
        ...
        return (
            ...
            <div id='header' >
                ...
                <div id='dark-mode' onClick={() => {this.onClickTheme(this.state.isDark)}} >
                        {this.state.isDark ? 
                            <svg id='light-mode-svg' viewBox='0 0 30 30' >
