    ...
    render () {
        ...
        return (
            <div id='board'>
                ...
                <rect className='after-result-decision' x='3' y='17' rx='0.3' ry='0.3' />
                <text className='after-result-decision after-result-decision-text' x='3.7' y='17.76' onClick={onClickEndGame} >Home</text>
                <rect className='after-result-decision' x='14.8' y='17' rx='0.3' ry='0.3' />
                <text className='after-result-decision after-result-decision-text' x='15.15' y='17.76' onClick={onClickNextRound} >Rematch</text>
                </svg>
            </div>
        );
    }
